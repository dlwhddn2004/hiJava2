...
public class T12_ThreadYieldTest {
	...
	public static void main(String[] args) {
		ThreadYield th1 = new ThreadYield("1번 마");
		ThreadYield th2 = new ThreadYield("2번 마");
...
class ThreadYield extends Thread{
	public boolean stop = false; //반복군을 제어할 목적으로 만든 변수
	public boolean work = true; //작업 실행을 제어할 목적으로 만든 변수
	
	public ThreadYield(String name) {
		//쓰레드에는 기본적으로 name속성이 있고, Thread생성자 중심에서는 
