...
public class T18_DialogTest extends  Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		//파일 열기 창
		Button btnFileOpen = new Button("Open FiledChooser 실행");
		...
		btnCustom.setOnAction(e->{
			...
			TextField txtName = (TextField) parent.lookup("#txtName"); //lookup 찾아보다.
			...
			// 5. Scene객체 생성해서 컨테이너객체 추가
			Scene scene = new Scene(parent);
			
			// 6. Stage객체에 Scene객체 추가하기
